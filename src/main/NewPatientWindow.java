...
public class NewPatientWindow extends JFrame {
    ...
    private void handleSubmit() {
        try {
            ...
            Patient patient = new Patient(name, surname, birthDate, address, phone, email, amkaInt, gender);

            // Εισαγωγή στη βάση δεδομένων
            SqlConnect sConnect = new SqlConnect();
            sConnect.insertPatient(amkaInt, name, surname, sqlBirthDate, phone, address, email, medicalHistory, gender);
    ...
    public static void main(String[] args) {
        new NewPatientWindow("01/01/2024", "09:00");
    }
}
